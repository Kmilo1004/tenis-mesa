...
const estilos = StyleSheet.create({
  ...
  tarjetaValor: { fontSize: 32, fontWeight: '800', color: '#1d4ed8' },
  ...
  filaValor: { fontSize: 13, fontWeight: '700', color: '#1d4ed8' },
  error: { color: '#dc2626', marginTop: 8, textAlign: 'center' },
  boton: { backgroundColor: '#1d4ed8', paddingVertical: 14, borderRadius: 8, alignItems: 'center', marginTop: 8 },
